...
SERVICES = {
    ...
    "alexaforbusiness": {"endpoint_prefix": "a4b", "service_id": "alexa-for-business"},
    "apigateway": {"endpoint_prefix": "apigateway", "service_id": "api-gateway"},
    ...
    "autoscaling": {"endpoint_prefix": "autoscaling", "service_id": "auto-scaling"},
    ...
    "cloudfront": {"endpoint_prefix": "cloudfront", "service_id": "cloudfront"},
    "cloudhsm": {"endpoint_prefix": "cloudhsm", "service_id": "cloudhsm"},
    "cloudhsmv2": {"endpoint_prefix": "cloudhsmv2", "service_id": "cloudhsm-v2"},
    "cloudsearch": {"endpoint_prefix": "cloudsearch", "service_id": "cloudsearch"},
    "cloudsearchdomain": {
        "endpoint_prefix": "cloudsearchdomain",
        "service_id": "cloudsearch-domain",
    },
    "cloudtrail": {"endpoint_prefix": "cloudtrail", "service_id": "cloudtrail"},
    "cloudwatch": {"endpoint_prefix": "monitoring", "service_id": "cloudwatch"},
    "codebuild": {"endpoint_prefix": "codebuild", "service_id": "codebuild"},
    "codecommit": {"endpoint_prefix": "codecommit", "service_id": "codecommit"},
    "codedeploy": {"endpoint_prefix": "codedeploy", "service_id": "codedeploy"},
    "codepipeline": {"endpoint_prefix": "codepipeline", "service_id": "codepipeline"},
    ...
    "cognito-sync": {"endpoint_prefix": "cognito-sync", "service_id": "cognito-sync"},
    "comprehend": {"endpoint_prefix": "comprehend", "service_id": "comprehend"},
    "config": {"endpoint_prefix": "config", "service_id": "config-service"},
    "connect": {"endpoint_prefix": "connect", "service_id": "connect"},
    "cur": {"endpoint_prefix": "cur", "service_id": "cost-and-usage-report-service"},
    "datapipeline": {"endpoint_prefix": "datapipeline", "service_id": "data-pipeline"},
    "dax": {"endpoint_prefix": "dax", "service_id": "dax"},
    "devicefarm": {"endpoint_prefix": "devicefarm", "service_id": "device-farm"},
    "directconnect": {
    ...
    "dms": {"endpoint_prefix": "dms", "service_id": "database-migration-service"},
    ...
    "elasticache": {"endpoint_prefix": "elasticache", "service_id": "elasticache"},
    "elasticbeanstalk": {
    ...
    "greengrass": {"endpoint_prefix": "greengrass", "service_id": "greengrass"},
    ...
    "importexport": {"endpoint_prefix": "importexport", "service_id": "importexport"},
    "inspector": {"endpoint_prefix": "inspector", "service_id": "inspector"},
    "iot": {"endpoint_prefix": "iot", "service_id": "iot"},
    "iot-data": {"endpoint_prefix": "data.iot", "service_id": "iot-data-plane"},
    "iot-jobs-data": {
    ...
    "iotanalytics": {"endpoint_prefix": "iotanalytics", "service_id": "iotanalytics"},
    "kinesis": {"endpoint_prefix": "kinesis", "service_id": "kinesis"},
    "kinesis-video-archived-media": {"service_id": "kinesis-video-archived-media"},
    "kinesis-video-media": {"service_id": "kinesis-video-media"},
    "kinesisanalytics": {
        "endpoint_prefix": "kinesisanalytics",
        "service_id": "kinesis-analytics",
    },
    "kinesisvideo": {"endpoint_prefix": "kinesisvideo", "service_id": "kinesis-video"},
    ...
    "mediaconvert": {"endpoint_prefix": "mediaconvert", "service_id": "mediaconvert"},
    "medialive": {"endpoint_prefix": "medialive", "service_id": "medialive"},
    "mediapackage": {"endpoint_prefix": "mediapackage", "service_id": "mediapackage"},
    "mediastore": {"endpoint_prefix": "mediastore", "service_id": "mediastore"},
    "mediastore-data": {
        "endpoint_prefix": "data.mediastore",
        "service_id": "mediastore-data",
    },
    "mediatailor": {"endpoint_prefix": "api.mediatailor", "service_id": "mediatailor"},
    "meteringmarketplace": {
    ...
    "opsworkscm": {"endpoint_prefix": "opsworks-cm", "service_id": "opsworkscm"},
    "organizations": {
    ...
    "rekognition": {"endpoint_prefix": "rekognition", "service_id": "rekognition"},
    "resource-groups": {
    ...
    "sagemaker": {"endpoint_prefix": "api.sagemaker", "service_id": "sagemaker"},
    "sagemaker-runtime": {
