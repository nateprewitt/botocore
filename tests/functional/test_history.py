...
class TestRecordStatementsInjections(BaseSessionTest):
    ...
    def test_does_record_api_call(self):
        ...
        self.assertEqual(
            payload, {"operation": u"ListBuckets", "params": {}, "service": "s3"}
        )
    ...
    def test_does_record_parsed_response(self):
        ...
        parsed_response_events = self._get_all_events_of_type("PARSED_RESPONSE")
        ...
        owner = payload["Owner"]
        self.assertEqual(
            owner, {"DisplayName": "foo", "ID": "d41d8cd98f00b204e9800998ecf8427e"}
        )
