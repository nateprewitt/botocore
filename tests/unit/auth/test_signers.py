...
class TestHMACV1(unittest.TestCase):
    ...
    def test_resign_with_token(self):
        ...
        auth.add_auth(request)
        self.assertEqual(request.headers.get_all("Authorization"), [original_auth])
...
class TestSigV2(unittest.TestCase):
    ...
    def setUp(self):
        ...
        mocked_time.return_value = time.struct_time([2014, 6, 20, 8, 40, 23, 4, 171, 0])
    ...
    def test_fields(self):
        ...
        self.assertEqual(
            request.data["Signature"], u"Tiecw+t51tok4dTT8B4bg47zxHEM/KcD55f2/x6K22o="
        )
...
class TestS3SigV4Auth(BaseTestWithFixedDate):
    ...
    def test_resign_with_content_hash(self):
        ...
        self.auth.add_auth(self.request)
        self.assertEqual(self.request.headers.get_all("Authorization"), [original_auth])
    ...
    def test_blacklist_trace_id(self):
        self._test_blacklist_header("x-amzn-trace-id", "Root=foo;Parent=bar;Sampleid=1")
...
class TestSigV4(unittest.TestCase):
    ...
    def test_thread_safe_timestamp(self):
        ...
        with mock.patch.object(
            ...
            mock_datetime.utcnow.return_value = datetime.datetime(2014, 1, 2, 0, 0)
    ...
    def test_payload_is_binary_file(self):
        ...
        self.assertEqual(
            payload, "1dabba21cdad44541f6b15796f8d22978fc7ea10c46aeceeeeb66c23b3ac7604"
        )
...
class TestS3SigV2Presign(BasePresignTest):
    def setUp(self):
        ...
        self.key = "myobject"
        self.path = "https://s3.amazonaws.com/%s/%s" % (self.bucket, self.key)
    ...
    def test_presign_no_headers(self):
        ...
        self.assertEqual(query_string["AWSAccessKeyId"], self.access_key)
        self.assertEqual(
            query_string["Expires"], str(int(self.current_epoch_time) + self.expires)
        )
        self.assertEqual(query_string["Signature"], "ZRSgywstwIruKLTLt/Bcrf9H1K4=")
    ...
    def test_presign_with_x_amz_headers(self):
        ...
        self.assertEqual(query_string["Signature"], "5oyMAGiUk1E5Ry2BnFr6cIS3Gus=")
    ...
    def test_presign_with_content_headers(self):
        ...
        self.assertEqual(query_string["Signature"], "/YQRFdQGywXP74WrOx2ET/RUqz8=")
...
class TestSigV4Presign(BasePresignTest):
    ...
    def test_presign_where_body_is_json_bytes(self):
        ...
        expected_query_string = {
            ...
            "X-Amz-Date": "20140101T000000Z",
            "X-Amz-Signature": (
                "8e1d372d168d532313ce6df8f64a7dc51d" "e6f312a9cfba6e5b345d8a771e839c"
            ),
            "X-Amz-SignedHeaders": "host",
            "Param": "value",
        }
...
class TestS3SigV2Post(BaseS3PresignPostTest):
    ...
    def test_presign_post(self):
        ...
        self.assertEqual(result_fields["AWSAccessKeyId"], self.credentials.access_key)

        result_policy = json.loads(
            base64.b64decode(result_fields["policy"]).decode("utf-8")
        )
        self.assertEqual(result_policy["expiration"], "2007-12-01T12:00:00.000Z")
        self.assertEqual(
