...
class TestS3Addressing(BaseSessionTest):
    ...
    def test_list_objects_dns_name(self):
        ...
        self.assertEqual(prepared_request.url, "https://safename.s3.amazonaws.com/")
    ...
    def test_list_objects_non_dns_name(self):
        ...
        self.assertEqual(prepared_request.url, "https://s3.amazonaws.com/un_safe_name")
    ...
    def test_list_objects_dns_name_non_classic(self):
        ...
        self.assertEqual(
            prepared_request.url, "https://safename.s3.us-west-2.amazonaws.com/"
        )

    def test_list_objects_unicode_query_string_eu_central_1(self):
        self.region_name = "eu-central-1"
        params = OrderedDict(
            [("Bucket", "safename"), ("Marker", u"\xe4\xf6\xfc-01.txt")]
        )
    ...
    def test_list_objects_in_restricted_regions(self):
        ...
        self.assertEqual(
            prepared_request.url, "https://safename.s3.us-gov-west-1.amazonaws.com/"
        )
    ...
    def test_get_object_non_dns_name_classic(self):
        ...
        prepared_request = self.get_prepared_request("get_object", params)
        self.assertEqual(
            prepared_request.url, "https://s3.amazonaws.com/AnInvalidName/mykeyname"
        )
