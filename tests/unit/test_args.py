...
class TestCreateClientArgs(unittest.TestCase):
    def setUp(self):
        ...
        self.default_socket_options = [(socket.IPPROTO_TCP, socket.TCP_NODELAY, 1)]
    ...
    def _get_service_model(self, service_name=None):
        ...
        service_model.metadata = {"serviceFullName": "MyService", "protocol": "query"}
    ...
    def test_compute_s3_config_only_config_store(self):
        self.config_store.set_config_variable("s3", {"use_accelerate_endpoint": True})
        self.assertEqual(
            self.args_create.compute_s3_config(None), {"use_accelerate_endpoint": True}
        )
    ...
    def test_client_s3_accelerate_client_config_overrides_config_store(self):
        self.config_store.set_config_variable("s3", {"use_accelerate_endpoint": False})
        self.assertEqual(
            self.args_create.compute_s3_config(
                client_config=Config(s3={"use_accelerate_endpoint": True})
            ),
    ...
    def test_proxies_from_client_config_forwarded_to_endpoint_creator(self):
        proxies = {"http": "http://foo.bar:1234", "https": "https://foo.bar:4321"}
    ...
    def test_s3_with_endpoint_url_still_resolves_region(self):
        ...
        client_args = self.call_get_client_args(endpoint_url="http://other.com/")
    ...
    def test_sts_override_resolved_endpoint_for_legacy_region(self):
        self.config_store.set_config_variable("sts_regional_endpoints", "legacy")
        client_args = self.call_get_client_args(
            service_model=self._get_service_model("sts"),
            region_name="us-west-2",
            endpoint_url=None,
        )
        self.assertEqual(client_args["endpoint"].host, "https://sts.amazonaws.com")
        self.assertEqual(client_args["request_signer"].region_name, "us-east-1")
    ...
    def test_sts_use_resolved_endpoint_for_nonlegacy_region(self):
        ...
        self.assertEqual(client_args["request_signer"].region_name, resolved_region)
    ...
    def test_sts_use_resolved_endpoint_for_regional_configuration(self):
        ...
        self.config_store.set_config_variable("sts_regional_endpoints", "regional")
        client_args = self.call_get_client_args(
            service_model=self._get_service_model("sts"),
            region_name="us-west-2",
            endpoint_url=None,
    ...
    def test_sts_http_scheme_for_override_endpoint(self):
        ...
        self.assertEqual(client_args["endpoint"].host, "http://sts.amazonaws.com")
    ...
    def test_invalid_sts_regional_endpoints(self):
        self.config_store.set_config_variable("sts_regional_endpoints", "invalid")
        with self.assertRaises(exceptions.InvalidSTSRegionalEndpointsConfigError):
    ...
    def test_provides_total_max_attempts(self):
        ...
        self.assertEqual(client_args["client_config"].retries["total_max_attempts"], 10)
    ...
    def test_provide_retry_config_maps_total_max_attempts(self):
        ...
        client_args = self.call_get_client_args(client_config=config)
        self.assertEqual(client_args["client_config"].retries["total_max_attempts"], 11)
        self.assertNotIn("max_attempts", client_args["client_config"].retries)
