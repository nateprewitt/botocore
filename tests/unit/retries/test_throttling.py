...
class TestCubicCalculator(unittest.TestCase):
    ...
    def test_starting_params(self):
        ...
        self.assertAlmostEqual(cubic.get_params_snapshot().k, 1.9574338205844317)
    ...
    def test_success_responses_until_max_hit(self):
        ...
        self.assertGreaterEqual(cubic.success_received(start_k * 1.1), start_w_max)
        self.assertGreaterEqual(cubic.success_received(start_k * 2.0), start_w_max)
    ...
    def test_error_response_decreases_rate_by_beta(self):
        ...
        new_rate = cubic.error_received(current_rate=rate_when_throttled, timestamp=1)
