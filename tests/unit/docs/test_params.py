...
class TestDocumentExclude(BaseParamsDocumenterTest):
    ...
    def test_request_params(self):
        ...
        self.assert_contains_lines_in_order(
            [":type Bar: string", ":param Bar: **[REQUIRED]** This describes bar."]
        )
    ...
    def test_response_params(self):
        ...
        self.assert_not_contains_line("  - **Foo** *(string) --* This describes foo.")
...
class TestDocumentRecursiveShape(BaseParamsDocumenterTest):
    ...
    def test_response_params(self):
        ...
        self.assert_contains_lines_in_order(
            ["- *(dict) --*", "  - **Foo** *(dict) --* This is a recursive structure.",]
        )
