...
class TestDocumentDefaultValue(BaseExampleDocumenterTest):
    ...
    def test_request_example(self):
        ...
        self.assert_contains_lines_in_order(
            ["::", "  response = myclient.call(", "      Foo='string'", "  )"]
        )
...
class TestDocumentNoMembers(BaseExampleDocumenterTest):
    ...
    def test_request_example(self):
        ...
        self.assert_contains_lines_in_order(["::", "  response = myclient.call()"])
...
class TestDocumentEnumValue(BaseExampleDocumenterTest):
    def setUp(self):
        ...
        self.add_shape({"EnumString": {"type": "string", "enum": ["foo", "bar"]}})
    ...
    def test_request_example(self):
        ...
        self.assert_contains_lines_in_order(
            ["::", "  response = myclient.call(", "      Foo='foo'|'bar'", "  )"]
        )
...
class TestDocumentInclude(BaseExampleDocumenterTest):
    def setUp(self):
        ...
        self.include_params = [
            DocumentedShape(
                name="Baz", type_name="integer", documentation="This describes baz."
            )
        ]
...
class TestDocumentExclude(BaseExampleDocumenterTest):
    ...
    def test_request_example(self):
        ...
        self.assert_contains_lines_in_order(
            ["::", "  response = myclient.call(", "      Bar='string'", "  )"]
        )
        ...
        self.add_shape(
            {
                "List": {
                    "type": "list",
                    "member": {"shape": "String", "documentation": "A string element"},
                }
            }
        )
...
class TestDocumentStructure(BaseExampleDocumenterTest):
    def setUp(self):
        ...
        self.add_shape_to_params("Foo", "Structure", "This describes the structure.")
