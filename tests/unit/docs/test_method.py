...
class TestGetInstanceMethods(unittest.TestCase):
    ...
    def test_get_instance_methods(self):
        ...
        self.assertEqual(instance.public_method, instance_methods["public_method"])
...
class TestDocumentModelDrivenSignature(BaseDocsTest):
    ...
    def test_document_signature_exclude_and_include(self):
        exclude_params = ["Foo", "Bar", "Baz"]
        include_params = [
            DocumentedShape(name="Biz", type_name="integer", documentation="biz docs")
        ]
        document_model_driven_signature(
            self.doc_structure,
            "my_method",
...
class TestDocumentCustomSignature(BaseDocsTest):
    ...
    def test_document_signature(self):
        document_custom_signature(self.doc_structure, "my_method", self.sample_method)
        self.assert_contains_line(".. py:method:: my_method(foo, bar='bar', baz=None)")
...
class TestDocumentCustomMethod(BaseDocsTest):
    ...
    def test_document_custom_signature(self):
        document_custom_method(self.doc_structure, "my_method", self.custom_method)
...
class TestDocumentModelDrivenMethod(BaseDocsTest):
    ...
    def test_include_input(self):
        include_params = [
            DocumentedShape(name="Biz", type_name="string", documentation="biz docs")
        ]
        document_model_driven_method(
            self.doc_structure,
            "foo",
    ...
    def test_streaming_body_in_output(self):
        ...
        self.json_model["shapes"]["SampleOperationInputOutput"]["payload"] = "Body"
        document_model_driven_method(
            self.doc_structure,
            "foo",
            self.operation_model,
    ...
    def test_event_stream_body_in_output(self):
        ...
        self.json_model["shapes"]["SampleOperationInputOutput"]["payload"] = "Payload"
        ...
        self.json_model["shapes"]["Event"] = {
            "type": "structure",
            "event": True,
            "members": {"Fields": {"shape": "EventFields", "eventpayload": True,}},
        }
    ...
    def test_streaming_body_in_input(self):
        ...
        self.assert_contains_line(":type Body: bytes or seekable file-like object")
