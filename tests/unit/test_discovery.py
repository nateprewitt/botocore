        ...
        self.service_description = {
            ...
            "shapes": {
                ...
                "TestDiscoveryIdsRequest": {
                    ...
                    "required": ["Foo", "Nested"],
                    "members": {
                        "Foo": {"shape": "String", "endpointdiscoveryid": True,},
                        "Baz": {"shape": "String"},
                        "Nested": {"shape": "Nested"},
                    },
                },
                ...
                "Nested": {
                    ...
                    "required": "Bar",
                    "members": {
                        "Bar": {"shape": "String", "endpointdiscoveryid": True,}
                    },
                },
            },
        }
...
class TestEndpointDiscoveryManager(BaseEndpointDiscoveryTest):
    ...
    def construct_manager(self, cache=None, time=None, side_effect=None):
        ...
        if side_effect is None:
            side_effect = [
                {"Endpoints": [{"Address": "new.com", "CachePeriodInMinutes": 2,}]}
            ]
    ...
    def test_injects_api_version_if_endpoint_operation(self):
        ...
        self.assertEqual(params["headers"].get("x-amz-api-version"), "2018-08-31")
    ...
    def test_describe_endpoint_expired_entry(self):
        ...
        key = ()
        cache = {key: [{"Address": "old.com", "Expiration": current_time - 10}]}
        self.construct_manager(cache=cache)
        kwargs = {
            "Identifiers": {},
            "Operation": "TestDiscoveryRequired",
