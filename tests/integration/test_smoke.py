...
ERROR_TESTS = {
    ...
    "application-autoscaling": {
        "DescribeScalableTargets": {"ServiceNamespace": "fake-service-namespace"}
    },
    "autoscaling": {
    ...
    "config": {"GetResourceConfigHistory": {"resourceType": "", "resourceId": "fake"},},
    ...
    "elasticbeanstalk": {"DescribeEnvironmentResources": {"EnvironmentId": "x"},},
...
def _make_error_client_call(client, operation_name, kwargs):
    ...
    try:
        ...
        raise AssertionError(
            "Expected client error was not raised "
...
def _make_client_call_with_errors(client, operation_name, kwargs):
    ...
    with ClientHTTPStubber(client, strict=False) as http_stubber:
        ...
        try:
            ...
            assert (
                False
            ), "Request was not retried properly, " "received error:\n%s" % pformat(e)
